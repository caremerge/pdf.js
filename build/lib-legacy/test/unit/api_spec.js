...
describe("api", function () {
  ...
  describe("getDocument", function () {
    ...
    it("creates pdf doc from typed array", function (done) {
      var typedArrayPdfPromise = _test_utils.DefaultFileReaderFactory.fetch({
    ...
    it("creates pdf doc from empty typed array", function (done) {
      var loadingTask = (0, _api.getDocument)(new Uint8Array(0));
      loadingTask.promise.then(function () {
  ...
  describe("PDFDocument", function () {
    ...
    it("gets page, from /Pages tree with circular reference", function (done) {
      var loadingTask = (0, _api.getDocument)((0, _test_utils.buildGetDocumentParams)("Pages-tree-refs.pdf"));
      var page1 = loadingTask.promise.then(function (pdfDoc) {
      ...
      var page2 = loadingTask.promise.then(function (pdfDoc) {
    ...
    it("gets non-string destination", function (done) {
      var numberPromise = pdfDocument.getDestination(4.3);
      var booleanPromise = pdfDocument.getDestination(true);
      var arrayPromise = pdfDocument.getDestination([{
        num: 17,
        gen: 0
      }, {
        name: "XYZ"
    ...
    it("gets non-default open action (with Print action)", function (done) {
      var loadingTask1 = (0, _api.getDocument)((0, _test_utils.buildGetDocumentParams)("bug1001080.pdf"));
      var loadingTask2 = (0, _api.getDocument)((0, _test_utils.buildGetDocumentParams)("issue11442_reduced.pdf"));
      var promise1 = loadingTask1.promise.then(function (pdfDoc) {
        return pdfDoc.getOpenAction();
      }).then(function (openAction) {
    ...
    it("gets JSActions (none)", function (done) {
      var promise = pdfDocument.getJSActions();
      promise.then(function (data) {
        expect(data).toEqual(null);
        done();
      })["catch"](done.fail);
    ...
    it("gets JSActions", function (done) {
      var loadingTask = (0, _api.getDocument)((0, _test_utils.buildGetDocumentParams)("doc_actions.pdf"));
      var promise = loadingTask.promise.then( /*#__PURE__*/function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator["default"].mark(function _callee(pdfDoc) {
          var docActions, page1, page3, page1Actions, page3Actions;
          return _regenerator["default"].wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 11:
                  page1Actions = _context.sent;
                  _context.next = 14;
                  return page3.getJSActions();

                case 14:
                  page3Actions = _context.sent;
                  return _context.abrupt("return", [docActions, page1Actions, page3Actions]);
      ...
      promise.then( /*#__PURE__*/function () {
        var _ref3 = _asyncToGenerator( /*#__PURE__*/_regenerator["default"].mark(function _callee2(_ref2) {
          var _ref4, docActions, page1Actions, page3Actions;

          return _regenerator["default"].wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  _ref4 = _slicedToArray(_ref2, 3), docActions = _ref4[0], page1Actions = _ref4[1], page3Actions = _ref4[2];
    ...
    it("gets metadata", function (done) {
      ...
      promise.then(function (_ref5) {
        var info = _ref5.info,
            ...
            contentLength = _ref5.contentLength;
    ...
    it("gets metadata, with missing PDF header (bug 1606566)", function (done) {
      var loadingTask = (0, _api.getDocument)((0, _test_utils.buildGetDocumentParams)("bug1606566.pdf"));
      loadingTask.promise.then(function (pdfDoc) {
        return pdfDoc.getMetadata();
      }).then(function (_ref7) {
        var info = _ref7.info,
            metadata = _ref7.metadata,
            contentDispositionFilename = _ref7.contentDispositionFilename,
            contentLength = _ref7.contentLength;
    ...
    it("gets markInfo", function (done) {
      var loadingTask = (0, _api.getDocument)((0, _test_utils.buildGetDocumentParams)("annotation-line.pdf"));
      loadingTask.promise.then(function (pdfDoc) {
    ...
    it("cleans up document resources", function (done) {
      var promise = pdfDocument.cleanup();
      promise.then(function () {
        expect(true).toEqual(true);
        done();
      }, done.fail);
  ...
  describe("Page", function () {
    ...
    it("gets view, with empty/invalid bounding boxes", function (done) {
      ...
      viewLoadingTask.promise.then(function (pdfDoc) {
        ...
        Promise.all(viewPromises).then(function (_ref8) {
    ...
    it("gets text content, with correct properties (issue 8276)", function (done) {
      ...
      loadingTask.promise.then(function (pdfDoc) {
        pdfDoc.getPage(1).then(function (pdfPage) {
          pdfPage.getTextContent().then(function (_ref10) {
    ...
    it("cleans up document resources during rendering of page", function (done) {
      ...
      loadingTask.promise.then(function (pdfDoc) {
        return pdfDoc.getPage(1).then(function (pdfPage) {
          ...
          return pdfDoc.cleanup().then(function () {
    ...
    it("caches image resources at the document/page level as expected (issue 11878)", /*#__PURE__*/function () {
      var _ref11 = _asyncToGenerator( /*#__PURE__*/_regenerator["default"].mark(function _callee3(done) {
        var NUM_PAGES_THRESHOLD, EXPECTED_WIDTH, EXPECTED_HEIGHT, loadingTask, firstImgData, pdfDoc, i, pdfPage, opList, commonObjs, objs, imgIndex, _opList$argsArray$img, objId, width, height, objsPool, currentImgData;
  ...
  describe("Multiple `getDocument` instances", function () {
    ...
    function renderPDF(_x4) {
      return _renderPDF.apply(this, arguments);
    }

    function _renderPDF() {
      _renderPDF = _asyncToGenerator( /*#__PURE__*/_regenerator["default"].mark(function _callee4(filename) {

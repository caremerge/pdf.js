...
describe("crypto", function () {
  ...
  describe("calculateMD5", function () {
    it("should pass RFC 1321 test #1", function () {
      var input = (0, _util.stringToBytes)("");
      var result = (0, _crypto.calculateMD5)(input, 0, input.length);
      var expected = hex2binary("d41d8cd98f00b204e9800998ecf8427e");
      expect(result).toEqual(expected);
    });
    it("should pass RFC 1321 test #2", function () {
      var input = (0, _util.stringToBytes)("a");
      var result = (0, _crypto.calculateMD5)(input, 0, input.length);
      var expected = hex2binary("0cc175b9c0f1b6a831c399e269772661");
      expect(result).toEqual(expected);
    });
    it("should pass RFC 1321 test #3", function () {
      var input = (0, _util.stringToBytes)("abc");
      var result = (0, _crypto.calculateMD5)(input, 0, input.length);
      var expected = hex2binary("900150983cd24fb0d6963f7d28e17f72");
      expect(result).toEqual(expected);
    });
    it("should pass RFC 1321 test #4", function () {
      var input = (0, _util.stringToBytes)("message digest");
      var result = (0, _crypto.calculateMD5)(input, 0, input.length);
      var expected = hex2binary("f96b697d7cb7938d525a2f31aaf161d0");
      expect(result).toEqual(expected);
    });
    it("should pass RFC 1321 test #5", function () {
      var input = (0, _util.stringToBytes)("abcdefghijklmnopqrstuvwxyz");
      var result = (0, _crypto.calculateMD5)(input, 0, input.length);
      var expected = hex2binary("c3fcd3d76192e4007dfb496cca67e13b");
      expect(result).toEqual(expected);
    });
    it("should pass RFC 1321 test #6", function () {
      var input = (0, _util.stringToBytes)("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789");
      var result = (0, _crypto.calculateMD5)(input, 0, input.length);
      var expected = hex2binary("d174ab98d277d9f5a5611c2c9f419d9f");
      expect(result).toEqual(expected);
    });
    it("should pass RFC 1321 test #7", function () {
      var input = (0, _util.stringToBytes)("123456789012345678901234567890123456789012345678" + "90123456789012345678901234567890");
      var result = (0, _crypto.calculateMD5)(input, 0, input.length);
      var expected = hex2binary("57edf4a22be3c955ac49da2e2107b67a");
      expect(result).toEqual(expected);
    });
  });
  describe("ARCFourCipher", function () {
    it("should pass test #1", function () {
      ...
      var cipher = new _crypto.ARCFourCipher(key);
      var result = cipher.encryptBlock(input);
  ...
  describe("calculateSHA256", function () {
    it("should properly hash abc", function () {
      var input = (0, _util.stringToBytes)("abc");
      var result = (0, _crypto.calculateSHA256)(input, 0, input.length);
      var expected = hex2binary("BA7816BF8F01CFEA414140DE5DAE2223B00361A396177A9CB410FF61F20015AD");
      expect(result).toEqual(expected);
    });
    it("should properly hash a multiblock input", function () {
      var input = (0, _util.stringToBytes)("abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq");
      var result = (0, _crypto.calculateSHA256)(input, 0, input.length);
      var expected = hex2binary("248D6A61D20638B8E5C026930C3E6039A33CE45964FF2167F6ECEDD419DB06C1");
      expect(result).toEqual(expected);
    });
  });
  describe("calculateSHA384", function () {
    it("should properly hash abc", function () {
      var input = (0, _util.stringToBytes)("abc");
      var result = (0, _crypto.calculateSHA384)(input, 0, input.length);
      var expected = hex2binary("CB00753F45A35E8BB5A03D699AC65007272C32AB0EDED163" + "1A8B605A43FF5BED8086072BA1E7CC2358BAECA134C825A7");
      expect(result).toEqual(expected);
    });
    it("should properly hash a multiblock input", function () {
      var input = (0, _util.stringToBytes)("abcdefghbcdefghicdefghijdefghijkefghijklfghijklm" + "ghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrs" + "mnopqrstnopqrstu");
      var result = (0, _crypto.calculateSHA384)(input, 0, input.length);
      var expected = hex2binary("09330C33F71147E83D192FC782CD1B4753111B173B3B05D2" + "2FA08086E3B0F712FCC7C71A557E2DB966C3E9FA91746039");
      expect(result).toEqual(expected);
    });
  });
  describe("calculateSHA512", function () {
    it("should properly hash abc", function () {
      var input = (0, _util.stringToBytes)("abc");
      var result = (0, _crypto.calculateSHA512)(input, 0, input.length);
      var expected = hex2binary("DDAF35A193617ABACC417349AE20413112E6FA4E89A97EA2" + "0A9EEEE64B55D39A2192992A274FC1A836BA3C23A3FEEBBD" + "454D4423643CE80E2A9AC94FA54CA49F");
      expect(result).toEqual(expected);
    });
    it("should properly hash a multiblock input", function () {
      var input = (0, _util.stringToBytes)("abcdefghbcdefghicdefghijdefghijkefghijklfghijklm" + "ghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrs" + "mnopqrstnopqrstu");
      var result = (0, _crypto.calculateSHA512)(input, 0, input.length);
      var expected = hex2binary("8E959B75DAE313DA8CF4F72814FC143F8F7779C6EB9F7FA1" + "7299AEADB6889018501D289E4900F7E4331B99DEC4B5433A" + "C7D329EEB6DD26545E96E55B874BE909");
      expect(result).toEqual(expected);
    });
  });
  describe("AES128", function () {
    describe("Encryption", function () {
      it("should be able to encrypt a block", function () {
        var input = hex2binary("00112233445566778899aabbccddeeff");
        var key = hex2binary("000102030405060708090a0b0c0d0e0f");
        var iv = hex2binary("00000000000000000000000000000000");
        var cipher = new _crypto.AES128Cipher(key);
        var result = cipher.encrypt(input, iv);
        var expected = hex2binary("69c4e0d86a7b0430d8cdb78070b4c55a");
        expect(result).toEqual(expected);
      });
    });
    describe("Decryption", function () {
      it("should be able to decrypt a block with IV in stream", function () {
        var input = hex2binary("0000000000000000000000000000000069c4e0d86a7b0430d" + "8cdb78070b4c55a");
        var key = hex2binary("000102030405060708090a0b0c0d0e0f");
        var cipher = new _crypto.AES128Cipher(key);
        var result = cipher.decryptBlock(input);
        var expected = hex2binary("00112233445566778899aabbccddeeff");
        expect(result).toEqual(expected);
      });
    });
  });
  describe("AES256", function () {
    describe("Encryption", function () {
      it("should be able to encrypt a block", function () {
        var input = hex2binary("00112233445566778899aabbccddeeff");
        var key = hex2binary("000102030405060708090a0b0c0d0e0f101112131415161718" + "191a1b1c1d1e1f");
        var iv = hex2binary("00000000000000000000000000000000");
        var cipher = new _crypto.AES256Cipher(key);
        var result = cipher.encrypt(input, iv);
        var expected = hex2binary("8ea2b7ca516745bfeafc49904b496089");
        expect(result).toEqual(expected);
      });
    });
    describe("Decryption", function () {
      it("should be able to decrypt a block with specified iv", function () {
        var input = hex2binary("8ea2b7ca516745bfeafc49904b496089");
        var key = hex2binary("000102030405060708090a0b0c0d0e0f101112131415161718" + "191a1b1c1d1e1f");
        var iv = hex2binary("00000000000000000000000000000000");
        var cipher = new _crypto.AES256Cipher(key);
        var result = cipher.decryptBlock(input, false, iv);
        var expected = hex2binary("00112233445566778899aabbccddeeff");
        expect(result).toEqual(expected);
      });
      it("should be able to decrypt a block with IV in stream", function () {
        var input = hex2binary("000000000000000000000000000000008ea2b7ca516745bf" + "eafc49904b496089");
        var key = hex2binary("000102030405060708090a0b0c0d0e0f101112131415161718" + "191a1b1c1d1e1f");
        var cipher = new _crypto.AES256Cipher(key);
        var result = cipher.decryptBlock(input, false);
        var expected = hex2binary("00112233445566778899aabbccddeeff");
        expect(result).toEqual(expected);
      });
    });
  ...
  describe("PDF17Algorithm", function () {
    it("should correctly check a user key", function () {
      var alg = new _crypto.PDF17();
      var password = new Uint8Array([117, 115, 101, 114]);
      var userValidation = new Uint8Array([117, 169, 4, 32, 159, 101, 22, 220]);
      var userPassword = new Uint8Array([131, 242, 143, 160, 87, 2, 138, 134, 79, 253, 189, 173, 224, 73, 144, 241, 190, 81, 197, 15, 249, 105, 145, 151, 15, 194, 65, 3, 1, 126, 187, 221]);
      var result = alg.checkUserPassword(password, userValidation, userPassword);
      expect(result).toEqual(true);
    });
    it("should correctly check an owner key", function () {
      var alg = new _crypto.PDF17();
      var password = new Uint8Array([111, 119, 110, 101, 114]);
      var ownerValidation = new Uint8Array([243, 118, 71, 153, 128, 17, 101, 62]);
      var ownerPassword = new Uint8Array([60, 98, 137, 35, 51, 101, 200, 152, 210, 178, 226, 228, 134, 205, 163, 24, 204, 126, 177, 36, 106, 50, 36, 125, 210, 172, 171, 120, 222, 108, 139, 115]);
      var uBytes = new Uint8Array([131, 242, 143, 160, 87, 2, 138, 134, 79, 253, 189, 173, 224, 73, 144, 241, 190, 81, 197, 15, 249, 105, 145, 151, 15, 194, 65, 3, 1, 126, 187, 221, 117, 169, 4, 32, 159, 101, 22, 220, 168, 94, 215, 192, 100, 38, 188, 40]);
      var result = alg.checkOwnerPassword(password, ownerValidation, uBytes, ownerPassword);
      expect(result).toEqual(true);
    });
    it("should generate a file encryption key from the user key", function () {
      var alg = new _crypto.PDF17();
      var password = new Uint8Array([117, 115, 101, 114]);
      var userKeySalt = new Uint8Array([168, 94, 215, 192, 100, 38, 188, 40]);
      var userEncryption = new Uint8Array([35, 150, 195, 169, 245, 51, 51, 255, 158, 158, 33, 242, 231, 75, 125, 190, 25, 126, 172, 114, 195, 244, 137, 245, 234, 165, 42, 74, 60, 38, 17, 17]);
      var result = alg.getUserKey(password, userKeySalt, userEncryption);
      var expected = new Uint8Array([63, 114, 136, 209, 87, 61, 12, 30, 249, 1, 186, 144, 254, 248, 163, 153, 151, 51, 133, 10, 80, 152, 206, 15, 72, 187, 231, 33, 224, 239, 13, 213]);
      expect(result).toEqual(expected);
    });
    it("should generate a file encryption key from the owner key", function () {
      var alg = new _crypto.PDF17();
      var password = new Uint8Array([111, 119, 110, 101, 114]);
      var ownerKeySalt = new Uint8Array([200, 245, 242, 12, 218, 123, 24, 120]);
      var ownerEncryption = new Uint8Array([213, 202, 14, 189, 110, 76, 70, 191, 6, 195, 10, 190, 157, 100, 144, 85, 8, 62, 123, 178, 156, 229, 50, 40, 229, 216, 54, 222, 34, 38, 106, 223]);
      var uBytes = new Uint8Array([131, 242, 143, 160, 87, 2, 138, 134, 79, 253, 189, 173, 224, 73, 144, 241, 190, 81, 197, 15, 249, 105, 145, 151, 15, 194, 65, 3, 1, 126, 187, 221, 117, 169, 4, 32, 159, 101, 22, 220, 168, 94, 215, 192, 100, 38, 188, 40]);
      var result = alg.getOwnerKey(password, ownerKeySalt, uBytes, ownerEncryption);
      var expected = new Uint8Array([63, 114, 136, 209, 87, 61, 12, 30, 249, 1, 186, 144, 254, 248, 163, 153, 151, 51, 133, 10, 80, 152, 206, 15, 72, 187, 231, 33, 224, 239, 13, 213]);
      expect(result).toEqual(expected);
    });
  });
  describe("PDF20Algorithm", function () {
    it("should correctly check a user key", function () {
      var alg = new _crypto.PDF20();
      var password = new Uint8Array([117, 115, 101, 114]);
      var userValidation = new Uint8Array([83, 245, 146, 101, 198, 247, 34, 198]);
      var userPassword = new Uint8Array([94, 230, 205, 75, 166, 99, 250, 76, 219, 128, 17, 85, 57, 17, 33, 164, 150, 46, 103, 176, 160, 156, 187, 233, 166, 223, 163, 253, 147, 235, 95, 184]);
      var result = alg.checkUserPassword(password, userValidation, userPassword);
      expect(result).toEqual(true);
    });
    it("should correctly check an owner key", function () {
      var alg = new _crypto.PDF20();
      var password = new Uint8Array([111, 119, 110, 101, 114]);
      var ownerValidation = new Uint8Array([142, 232, 169, 208, 202, 214, 5, 185]);
      var ownerPassword = new Uint8Array([88, 232, 62, 54, 245, 26, 245, 209, 137, 123, 221, 72, 199, 49, 37, 217, 31, 74, 115, 167, 127, 158, 176, 77, 45, 163, 87, 47, 39, 90, 217, 141]);
      var uBytes = new Uint8Array([94, 230, 205, 75, 166, 99, 250, 76, 219, 128, 17, 85, 57, 17, 33, 164, 150, 46, 103, 176, 160, 156, 187, 233, 166, 223, 163, 253, 147, 235, 95, 184, 83, 245, 146, 101, 198, 247, 34, 198, 191, 11, 16, 94, 237, 216, 20, 175]);
      var result = alg.checkOwnerPassword(password, ownerValidation, uBytes, ownerPassword);
      expect(result).toEqual(true);
    });
    it("should generate a file encryption key from the user key", function () {
      var alg = new _crypto.PDF20();
      var password = new Uint8Array([117, 115, 101, 114]);
      var userKeySalt = new Uint8Array([191, 11, 16, 94, 237, 216, 20, 175]);
      var userEncryption = new Uint8Array([121, 208, 2, 181, 230, 89, 156, 60, 253, 143, 212, 28, 84, 180, 196, 177, 173, 128, 221, 107, 46, 20, 94, 186, 135, 51, 95, 24, 20, 223, 254, 36]);
      var result = alg.getUserKey(password, userKeySalt, userEncryption);
      var expected = new Uint8Array([42, 218, 213, 39, 73, 91, 72, 79, 67, 38, 248, 133, 18, 189, 61, 34, 107, 79, 29, 56, 59, 181, 213, 118, 113, 34, 65, 210, 87, 174, 22, 239]);
      expect(result).toEqual(expected);
    });
    it("should generate a file encryption key from the owner key", function () {
      var alg = new _crypto.PDF20();
      var password = new Uint8Array([111, 119, 110, 101, 114]);
      var ownerKeySalt = new Uint8Array([29, 208, 185, 46, 11, 76, 135, 149]);
      var ownerEncryption = new Uint8Array([209, 73, 224, 77, 103, 155, 201, 181, 190, 68, 223, 20, 62, 90, 56, 210, 5, 240, 178, 128, 238, 124, 68, 254, 253, 244, 62, 108, 208, 135, 10, 251]);
      var uBytes = new Uint8Array([94, 230, 205, 75, 166, 99, 250, 76, 219, 128, 17, 85, 57, 17, 33, 164, 150, 46, 103, 176, 160, 156, 187, 233, 166, 223, 163, 253, 147, 235, 95, 184, 83, 245, 146, 101, 198, 247, 34, 198, 191, 11, 16, 94, 237, 216, 20, 175]);
      var result = alg.getOwnerKey(password, ownerKeySalt, uBytes, ownerEncryption);
      var expected = new Uint8Array([42, 218, 213, 39, 73, 91, 72, 79, 67, 38, 248, 133, 18, 189, 61, 34, 107, 79, 29, 56, 59, 181, 213, 118, 113, 34, 65, 210, 87, 174, 22, 239]);
      expect(result).toEqual(expected);
...
describe("CipherTransformFactory", function () {
  ...
  function ensureEncryptDecryptIsIdentity(dict, fileId, password, string) {
    var factory = new _crypto.CipherTransformFactory(dict, fileId, password);
    var cipher = factory.createCipherTransform(123, 0);
    var encrypted = cipher.encryptString(string);
    var decrypted = cipher.decryptString(encrypted);

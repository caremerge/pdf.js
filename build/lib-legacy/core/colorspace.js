...
var ColorSpace = /*#__PURE__*/function () {
  ...
  _createClass(ColorSpace, [{
    ...
    value: function fillRgb(dest, originalWidth, originalHeight, width, height, actualHeight, bpc, comps, alpha01) {
      (0, _util.assert)(dest instanceof Uint8ClampedArray, 'ColorSpace.fillRgb: Unsupported "dest" type.');
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                (0, _util.assert)(!this.getCached(cs, xref, localColorSpaceCache), "Expected `ColorSpace.getCached` to have been manually checked " + "before calling `ColorSpace.parseAsync`.");
...
var AlternateCS = /*#__PURE__*/function (_ColorSpace) {
  ...
  _createClass(AlternateCS, [{
    key: "getRgbItem",
    value: function getRgbItem(src, srcOffset, dest, destOffset) {
      (0, _util.assert)(dest instanceof Uint8ClampedArray, 'AlternateCS.getRgbItem: Unsupported "dest" type.');
    ...
    key: "getRgbBuffer",
    value: function getRgbBuffer(src, srcOffset, count, dest, destOffset, bits, alpha01) {
      (0, _util.assert)(dest instanceof Uint8ClampedArray, 'AlternateCS.getRgbBuffer: Unsupported "dest" type.');
...
var IndexedCS = /*#__PURE__*/function (_ColorSpace3) {
  ...
  _createClass(IndexedCS, [{
    key: "getRgbItem",
    value: function getRgbItem(src, srcOffset, dest, destOffset) {
      (0, _util.assert)(dest instanceof Uint8ClampedArray, 'IndexedCS.getRgbItem: Unsupported "dest" type.');
    ...
    key: "getRgbBuffer",
    value: function getRgbBuffer(src, srcOffset, count, dest, destOffset, bits, alpha01) {
      (0, _util.assert)(dest instanceof Uint8ClampedArray, 'IndexedCS.getRgbBuffer: Unsupported "dest" type.');
      var base = this.base;
...
var DeviceGrayCS = /*#__PURE__*/function (_ColorSpace4) {
  ...
  _createClass(DeviceGrayCS, [{
    key: "getRgbItem",
    value: function getRgbItem(src, srcOffset, dest, destOffset) {
      (0, _util.assert)(dest instanceof Uint8ClampedArray, 'DeviceGrayCS.getRgbItem: Unsupported "dest" type.');
    ...
    key: "getRgbBuffer",
    value: function getRgbBuffer(src, srcOffset, count, dest, destOffset, bits, alpha01) {
      (0, _util.assert)(dest instanceof Uint8ClampedArray, 'DeviceGrayCS.getRgbBuffer: Unsupported "dest" type.');
...
var DeviceRgbCS = /*#__PURE__*/function (_ColorSpace5) {
  ...
  _createClass(DeviceRgbCS, [{
    key: "getRgbItem",
    value: function getRgbItem(src, srcOffset, dest, destOffset) {
      (0, _util.assert)(dest instanceof Uint8ClampedArray, 'DeviceRgbCS.getRgbItem: Unsupported "dest" type.');
    ...
    key: "getRgbBuffer",
    value: function getRgbBuffer(src, srcOffset, count, dest, destOffset, bits, alpha01) {
      (0, _util.assert)(dest instanceof Uint8ClampedArray, 'DeviceRgbCS.getRgbBuffer: Unsupported "dest" type.');
...
var DeviceCmykCS = function DeviceCmykCSClosure() {
  ...
  var DeviceCmykCS = /*#__PURE__*/function (_ColorSpace6) {
    ...
    _createClass(DeviceCmykCS, [{
      key: "getRgbItem",
      value: function getRgbItem(src, srcOffset, dest, destOffset) {
        (0, _util.assert)(dest instanceof Uint8ClampedArray, 'DeviceCmykCS.getRgbItem: Unsupported "dest" type.');
        convertToRgb(src, srcOffset, 1, dest, destOffset);
      }
    }, {
      key: "getRgbBuffer",
      value: function getRgbBuffer(src, srcOffset, count, dest, destOffset, bits, alpha01) {
        (0, _util.assert)(dest instanceof Uint8ClampedArray, 'DeviceCmykCS.getRgbBuffer: Unsupported "dest" type.');
        var scale = 1 / ((1 << bits) - 1);
...
var CalGrayCS = function CalGrayCSClosure() {
  ...
  var CalGrayCS = /*#__PURE__*/function (_ColorSpace7) {
    ...
    _createClass(CalGrayCS, [{
      key: "getRgbItem",
      value: function getRgbItem(src, srcOffset, dest, destOffset) {
        (0, _util.assert)(dest instanceof Uint8ClampedArray, 'CalGrayCS.getRgbItem: Unsupported "dest" type.');
        convertToRgb(this, src, srcOffset, dest, destOffset, 1);
      }
    }, {
      key: "getRgbBuffer",
      value: function getRgbBuffer(src, srcOffset, count, dest, destOffset, bits, alpha01) {
        (0, _util.assert)(dest instanceof Uint8ClampedArray, 'CalGrayCS.getRgbBuffer: Unsupported "dest" type.');
        var scale = 1 / ((1 << bits) - 1);
...
var CalRGBCS = function CalRGBCSClosure() {
  ...
  var CalRGBCS = /*#__PURE__*/function (_ColorSpace8) {
    ...
    _createClass(CalRGBCS, [{
      key: "getRgbItem",
      value: function getRgbItem(src, srcOffset, dest, destOffset) {
        (0, _util.assert)(dest instanceof Uint8ClampedArray, 'CalRGBCS.getRgbItem: Unsupported "dest" type.');
        convertToRgb(this, src, srcOffset, dest, destOffset, 1);
      }
    }, {
      key: "getRgbBuffer",
      value: function getRgbBuffer(src, srcOffset, count, dest, destOffset, bits, alpha01) {
        (0, _util.assert)(dest instanceof Uint8ClampedArray, 'CalRGBCS.getRgbBuffer: Unsupported "dest" type.');
        var scale = 1 / ((1 << bits) - 1);
...
var LabCS = function LabCSClosure() {
  ...
  var LabCS = /*#__PURE__*/function (_ColorSpace9) {
    ...
    _createClass(LabCS, [{
      key: "getRgbItem",
      value: function getRgbItem(src, srcOffset, dest, destOffset) {
        (0, _util.assert)(dest instanceof Uint8ClampedArray, 'LabCS.getRgbItem: Unsupported "dest" type.');
        convertToRgb(this, src, srcOffset, false, dest, destOffset);
      }
    }, {
      key: "getRgbBuffer",
      value: function getRgbBuffer(src, srcOffset, count, dest, destOffset, bits, alpha01) {
        (0, _util.assert)(dest instanceof Uint8ClampedArray, 'LabCS.getRgbBuffer: Unsupported "dest" type.');
        var maxVal = (1 << bits) - 1;

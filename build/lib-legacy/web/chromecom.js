...
function isRuntimeAvailable() {
  try {
    ...
    if ((_chrome$runtime = chrome.runtime) !== null && _chrome$runtime !== void 0 && _chrome$runtime.getManifest()) {
      return true;
    }
  } catch (e) {}
...
function requestAccessToLocalFile(fileUrl, overlayManager, callback) {
  ...
  chromeFileAccessOverlayPromise.then(function () {
    var _chrome$i18n$getUILan, _chrome$i18n;
    ...
    var i18nFileAccessLabel = {
      ...
      "zh-CN": "\u5141\u8BB8\u8BBF\u95EE\u6587\u4EF6\u7F51\u5740",
      "zh-TW": "\u5141\u8A31\u5B58\u53D6\u6A94\u6848\u7DB2\u5740"
    }[(_chrome$i18n$getUILan = (_chrome$i18n = chrome.i18n).getUILanguage) === null || _chrome$i18n$getUILan === void 0 ? void 0 : _chrome$i18n$getUILan.call(_chrome$i18n)];
...
function setReferer(url, callback) {
  ...
  port.postMessage({
    referer: (_window$history$state = window.history.state) === null || _window$history$state === void 0 ? void 0 : _window$history$state.chromecomState,
    requestUrl: url
  });
...
var ChromeExternalServices = /*#__PURE__*/function (_DefaultExternalServi) {
  _inherits(ChromeExternalServices, _DefaultExternalServi);

  var _super2 = _createSuper(ChromeExternalServices);

  function ChromeExternalServices() {
    _classCallCheck(this, ChromeExternalServices);

    return _super2.apply(this, arguments);
  }

  _createClass(ChromeExternalServices, null, [{
    ...
    key: "createScripting",
    value: function createScripting(_ref) {
      var sandboxBundleSrc = _ref.sandboxBundleSrc;
